...
echo $head2;
	...
	'<nav id="GalleryFooter"><p><a id="prevpagebutton" href="./getGallery.php" title="return to uploading gallery images">❮ Previous</a>&emsp;&copy; 2020 by&nbsp;<span><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 40.000000 40.000000" preserveAspectRatio="xMidYMid meet">
	...
	-51z"/>
		...
		echo date ("F d Y H:i:s.", getlastmod()).'&emsp;<a id="nextpagebutton" href="./getGalleryCaptions.php" title="get optional caption for each image">Next ❯</a></p></nav>'.
		'</footer>';
?>
      <script>
         $(function(){
            $("input[type = 'submit']").click(function(){
               ...
               if (parseInt($fileUpload.get(0).files.length) > 48){
                  alert("You are only allowed to upload 24 Gallery image alt text files!");
				  window.location.replace("https://syntheticreality.net/Galleries/getAltText.php");
               } 
            });
         });
      </script>
