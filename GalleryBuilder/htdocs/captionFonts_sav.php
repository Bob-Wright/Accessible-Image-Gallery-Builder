...
$head2 = <<< EOT2
	...
	<link href="/Galleries/css/bootstrap.css" rel="stylesheet" media="screen">
...
<link rel='stylesheet' href="/Galleries/css/LiteThemes.css">
	...
	<link href="/Galleries/css/GalleryCreator.css" rel="stylesheet">
	<link href="/Galleries/css/GalleryBuilder.css" rel="stylesheet">
...
echo $head2;
// list of fonts
$fontdir = '/home/bitnami/Galleries/htdocs/Fonts/';
$fontfiles = array();
$fontlabels = '';
...
for ($i = 0; $i <  count($fontfiles); $i++) {
	...
	$fontfile=$fontfiles[$fontIndex];
		...
		'src: url("/Galleries/Fonts/'.$fontfile.'.ttf") format("truetype");}'.
...
<h1 style="color:blue; text-align:center;">Choose Gallery Caption Fonts</h1>
        ...
        <div class="col-md-3 mb-4">
            <div class="color-block z-depth-2 secondary-color-lite #ce93d8">
             ...
             <div class="color-block z-depth-2 blue-grey #b0bec5 lighten-3">
                <label style="margin-left: 1vw;"><p><br><input id="blue-grey #b0bec5" class="fcheckbox" type="checkbox" name="Capcolor" /> &emsp;#b0bec5</p></label></div>
         </div>
    </div>
   <div class="row mx-1 d-flex col-sm-11">
        <div class="col-md-3 mb-4">
...
echo $colrs;
?>
<form class="d-flex col-sm-11 flex-column align-items-center shadow-md #b0bec5 blue-grey lighten-3 px-sm-0 infoBox" name="hfontinfo" action="saveFonts.php" method="post" enctype="text">
...
<br><label>Save the selected Fonts and Colors:<br><input type="submit" value="Apply"></label>
	...
	<nav id="navFooter"><p><a id="prevpagebutton" href="./getGalleryCaptions.php" title="return to the get captions page">❮ Previous</a>&nbsp;&copy; 2021 by&nbsp;<span><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 40.000000 40.000000" preserveAspectRatio="xMidYMid meet">
	...
	</svg></span>&nbsp;<a href="mailto:bob_wright@isoblock.com">Bob Wright.</a>&nbsp;Last modified&ensp;<?php echo date ("F d Y H:i:s.", getlastmod()) ?>&ensp;<a id="nextpagebutton" href="./getLogos.php" title="go to the Logo Image chooser">Next ❯</a></p></nav>
	</footer>
  <script type="text/javascript" src="/Galleries/js/jquery.min.js"></script>
  <script type="text/javascript" src="/Galleries/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="/Galleries/js/mdb.min.js"></script>
<script>
var $defhfont = 'Roboto-Bold';
var $defpfont = 'Merriweather-Regular';
var $defccolr = 'blue-grey #b0bec5';
$("#hfontval").html('@font-face {font-family: "'+$defhfont+'"; src: url("/Galleries/Fonts/'+$defhfont+'.ttf") format("truetype");} h1 { font: 2vw '+$defhfont+';} h2 { font: 1.75vw '+$defhfont+';} h3 { font: 1.5vw '+$defhfont+';}');
$("#pfontval").html('@font-face {font-family: "'+$defpfont+'"; src: url("/Galleries/Fonts/'+$defpfont+'.ttf") format("truetype");} .card-body, p { font: 1.5vw '+$defpfont+';} ');
var $str = $defccolr.substr(-7, 7);
$("#cbval").html('.xmplc {background: '+ $str +';}');
$("#xmplhdgs").html('@font-face {font-family: "'+$defhfont+'"; src: url("/Galleries/Fonts/'+$defhfont+'.ttf") format("truetype");} h1.xmplh { font: 2vw '+$defhfont+';} h2.xmplh { font: 1.75vw '+$defhfont+';} h3.xmplh { font: 1.5vw '+$defhfont+';}');
$("#xmplbody").html('@font-face {font-family: "'+$defpfont+'"; src: url("/Galleries/Fonts/'+$defpfont+'.ttf") format("truetype");} p.xmplp { font: 1.5vw '+$defpfont+';}');
...
var $id = this.id;
	...
	if(this.checked == true) {
		$("#hfontval").html('@font-face {font-family: "'+$id+'"; src: url("/Galleries/Fonts/'+$id+'.ttf") format("truetype");} h1 { font: 2vw '+$id+';} h2 { font: 1.75vw '+$id+';} h3 { font: 1.5vw '+$id+';}');
		$("#xmplhdgs").html('@font-face {font-family: "'+$id+'"; src: url("/Galleries/Fonts/'+$id+'.ttf") format("truetype");} h1.xmplh { font: 2vw '+$id+';} h2.xmplh { font: 1.75vw '+$id+';} h3.xmplh { font: 1.5vw '+$id+';}');
	} else {
		//$("#hfontval").html('');
		$("#hfontval").html('@font-face {font-family: "'+$defhfont+'"; src: url("/Galleries/Fonts/'+$defhfont+'.ttf") format("truetype");} h1 { font: 2vw '+$defhfont+';} h2 { font: 1.75vw '+$defhfont+';} h3 { font: 1.5vw '+$defhfont+';}');
		$("#xmplhdgs").html('@font-face {font-family: "'+$defhfont+'"; src: url("/Galleries/Fonts/'+$defhfont+'.ttf") format("truetype");} h1.xmplh { font: 2vw '+$defhfont+';} h2.xmplh { font: 1.75vw '+$defhfont+';} h3.xmplh { font: 1.5vw '+$defhfont+';}');
	...
	var $id = $id.substring(1);
	if(this.checked == true) {
		$("#pfontval").html('@font-face {font-family: "'+$id+'"; src: url("/Galleries/Fonts/'+$id+'.ttf") format("truetype");} p { font: 2vw '+$id+';} ');
		$("#xmplbody").html('@font-face {font-family: "'+$id+'"; src: url("/Galleries/Fonts/'+$id+'.ttf") format("truetype");} p.xmplp { font: 1.5vw '+$id+';}');
		} else {
		$("#pfontval").html('@font-face {font-family: "'+$defpfont+'"; src: url("/Galleries/Fonts/'+$defpfont+'.ttf") format("truetype");} p { font: 1.5vw '+$defpfont+';} ');
		$("#xmplbody").html('@font-face {font-family: "'+$defpfont+'"; src: url("/Galleries/Fonts/'+$defpfont+'.ttf") format("truetype");} p.xmplp { font: 1.5vw '+$defpfont+';}');
	}}
