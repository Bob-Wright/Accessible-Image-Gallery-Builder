 ...
 * this code processes the caption files uploaded by the Upload form
...
if(file_exists($uploadDir.$vpb_file_name)) {
	...
	if(!(is_dir('/home/bitnami/Galleries/htdocs/'.$galleryname.'/'.$pageimage))) {
	mkdir('/home/bitnami/Galleries/htdocs/'.$galleryname.'/'.$pageimage, 0775, true);
	}
	$targetDir = '/home/bitnami/Galleries/htdocs/'.$galleryname.'/'.$pageimage.'/';
