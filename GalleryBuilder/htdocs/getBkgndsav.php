...
<br>
<hr class="new3">
<p>The specific image that is needed for the <em>Page Background</em> that will be displayed on the site should be a JPG or PNG format and be about 1200 to 1400 pixels on a side. The selected image will be scaled to fill the browser window when the page is being viewed, and it has reduced opacity for a softer background.</p>
<br>
<hr class="new3">
<center>
...
echo $head2;
	...
	'<nav id="GalleryFooter"><p><a id="prevpagebutton" href="./getLogos.php" title="return to uploading logos">❮ Previous</a>&emsp;&copy; 2020 by&nbsp;<span><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 40.000000 40.000000" preserveAspectRatio="xMidYMid meet">
         ...
         $(function(){
            $("input[type = 'submit']").click(function(){
               ...
               if (parseInt($fileUpload.get(0).files.length) > 1){
				  ...
				  window.location.replace("https://syntheticreality.net/GalleryBuilder/getBkgnd.php");
               } 
            });
         });
      </script>
