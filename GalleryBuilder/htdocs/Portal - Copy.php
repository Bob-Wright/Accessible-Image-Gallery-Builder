...
'<div class="row justify-content-end fixed-top">
    <nav title="jump to the Galleries" class="btn btn-sm btn-yellow accent1">
		...
		</g><a xmlns="http://www.w3.org/2000/svg" id="anchor" xlink:href="https://syntheticreality.net/Galleries/Galleries.php" xmlns:xlink="http://www.w3.org/1999/xlink" target="_top"><rect x="0" y="0" width="100%" height="100%" fill-opacity="0"/></a>
		</svg>
    </nav>
</div>';
