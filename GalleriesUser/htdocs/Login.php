...
require_once '/home/bitnami/GalleriesUser/htdocs/config.php';
// Include get IP file
//require_once 'get_ip_address.php';
require_once '/home/bitnami/GalleriesUser/htdocs/get_ip_address.php';
// Include User class
...
if(isset($accessToken)){
    ...
    // Get logout url
    $logoutURL = $helper->getLogoutUrl($accessToken, FB_APP_URL.'GalleriesUser/logout.php');
    ...
    if(!empty($userData)){
        ...
        //$output .= '<b>Gallery Name:</b> '.$userData['gallery_name'].'</p>';
		$output .= '<p>This data will be associated with your account.</p>';
		$output .= '<p>The number of Hosted Users is '.$userCount.'.</p>';
        $output .= '</div>';
        $output .= '<div id="FBlogoutButton"><a href="'.$logoutURL.'"><img id="logoutButton"  src="../GalleriesUser/Images/facebook-logout-button.png" alt="Facebook logout button" title="Logout using Facebook"></a></div>';
        $output .= '</div>';
    ...
    $FBloginButton = '<a href='.htmlspecialchars($loginURL).'><img id="loginButton" src="../GalleriesUser/Images/facebook-sign-in-button.png" alt="Facebook login button" title="Logon using Facebook"></a>';
