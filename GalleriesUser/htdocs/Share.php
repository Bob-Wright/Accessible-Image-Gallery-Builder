...
if(!($_SERVER["REQUEST_METHOD"] == "POST")) {
	$location = '../GalleryBuilder/closeGalleryBuilder.php';
...
$head2 = <<< EOT2
	<meta name="description" content="GalleryBuilder">
	...
	<base href="https://syntheticreality.net/GalleriesUser/">
...
'<img class="Logo" id="Logo" src = "https://syntheticreality.net/GalleryBuilder/images/IsoBlockLOGO.gif" alt=""><div class="sitename" id="sitename" >IsoBlock</div>'.
'<span class="siteSubtitle">Synthetic Reality Division</span>'.
'</header>'.
'<button class="toggleMenu" id="toggleMenu"><div><a href="https://syntheticreality.net/Galleries/Galleries.php"><strong><span class="mdi mdi-home"></span></strong></a></div></button>';
...
<h2 style="text-align:center;">The Gallery Builder completed successfully. This page will let you share the Gallery to Facebook.</h2>

<p id="shareSuccess" style="display: none;">The Facebook Share dialog completed successfully.<br>You may share the Gallery again or you may logout.</p>
...
<img id="shareButton" src="https://syntheticreality.net/GalleriesUser/Images/facebook-share-gallery-button.png">

<!-- logout of gallery share button -->
<div id="logoutButton"><a id="logoutButtonURL" href="https://syntheticreality.net/GalleryBuilder/closeGalleryBuilder.php"><img src="https://syntheticreality.net/GalleriesUser/Images/facebook-logout-button.png"></a></div>
BODY1;
echo $body1;
...
echo '<div id="galleryNameValue" style="opacity: 0;">'.$_SESSION['userData']['gallery_name'].'</div>';
// Logout of GalleriesUser AND Facebook button
...
document.getElementById("shareButton").onclick = function() {
	var keyValue = document.getElementById("galleryNameValue").innerHTML;
	console.info("keyValue "+keyValue);
	FB.ui(
	{
	method: 'share',
	display: 'popup',
	href: 'https://syntheticreality.net/Galleries/'+keyValue+'.html'
	}, 
	function(response) {
	...
	document.getElementById("logoutButtonURL").href = "https://syntheticreality.net/GalleryBuilder/closeGalleryBuilder.php";
...
<?php
	...
	'</div>'.
	'<footer id="myFooter">'.
	'<div id="galleryFooter"><a id="prevpagebutton" href="/Galleries/Galleries.php">❮ Previous</a>&emsp;&copy; 2020 by&nbsp;<span class="mdi mdi-email"></span>&nbsp;<a href="mailto:bob_wright@isoblock.com">Bob Wright.</a>&nbsp;Last modified ';
