...
define('FB_APP_ID', '2917501244986193');
define('FB_APP_SECRET', 'your app secret goes here');
define('FB_REDIRECT_URL', 'https://syntheticreality.net/GalleryBuilder/');
define('PAGE_URL', 'Portal.php');
